...
class TransformEngine:
    ...
    def _startup(self, metadata_paths: list[str], seed: str, author_arg: str = None):
        self._init_db()
        if author_arg:
        ...
        self.tree_log = pathlib.Path("/data/seed_tree.jsonl")
...
if __name__ == '__main__':
    ...
    args = ap.parse_args()
    engine = TransformEngine(args.metadata, args.seed, getattr(args, 'author', None))
    interactive_loop(engine)
# Patch argparse to accept --author
